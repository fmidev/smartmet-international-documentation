...
### Step 2: Make SmartMet files available offline
...
### Step 4: Install Microsoft Visual C++ Redistributable
...
### Step 5: Install the graphics library (Uniras)
...
- Open Dropbox **Preferences** > **Sync** and make sure the SmartMet folder is set to **Available offline**. See Step 2 above.

**"Missing DLL" or "VCRUNTIME" error when starting SmartMet**
- Reinstall the Microsoft Visual C++ Redistributable by running `VC_redist.x64.exe` again (see Step 4).
...
- Try disconnecting and re-mapping the drive (see Step 9).
